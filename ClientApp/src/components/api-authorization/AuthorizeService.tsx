...
type ReturnValues = { status?: string; message?: string; state?: any };
...
export class AuthorizeService {
  ...
  async signIn(state: string): Promise<ReturnValues> {
    await this.ensureUserManagerInitialized();
    try {
  ...
  async completeSignIn(url: string): Promise<ReturnValues> {
    try {
      await this.ensureUserManagerInitialized();
  ...
  async signOut(state: string): Promise<ReturnValues> {
    await this.ensureUserManagerInitialized();
    try {
      if (this._popUpDisabled) {
        throw new Error(
  ...
  async completeSignOut(url: string): Promise<ReturnValues> {
    await this.ensureUserManagerInitialized();
    try {
